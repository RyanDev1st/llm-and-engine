...
**Open** (triage tomorrow): 5 CRITICAL/HIGH that touch architecture or UX and should NOT be changed blind — listed in **Next** with severity + repro + fix.
